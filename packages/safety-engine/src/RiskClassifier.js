import { BlastRadiusCalculator } from "./BlastRadius.js";
...
export class RiskClassifier {
    static classify(input) {
        ...
        let blastRadius;
        const commandStr = (typeof input.args["command"] === "string" ? input.args["command"] : typeof input.args["CommandLine"] === "string" ? input.args["CommandLine"] : "");
        const filePath = (typeof input.args["targetFile"] === "string" ? input.args["targetFile"] : typeof input.args["TargetFile"] === "string" ? input.args["TargetFile"] : typeof input.args["path"] === "string" ? input.args["path"] : "");
        if (commandStr) {
    ...
    static getToolBaseRisk(toolName, args) {
